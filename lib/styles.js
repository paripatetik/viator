...
export const buttonStyles = {
  primary:
    "bg-[#E7ECEE] border-2 border-[#1E2A32] text-[#1E2A32] uppercase font-bold tracking-wide px-10 py-3 rounded-full hover:bg-white active:scale-95 transition disabled:opacity-60",
  loadMore:
    "bg-[#416472] px-6 py-3 text-xl font-semibold text-white rounded-full hover:bg-[#314553] active:scale-95 transition-colors",
  categoryTrigger:
    "flex items-center gap-1 px-3 py-2 rounded bg-[#E7ECEE]/92 text-[#1E2A32] text-base uppercase",
  categoryPill:
    "px-3 py-1 rounded-full bg-[#E7ECEE] text-[#1E2A32] uppercase",
};
